  ...
  return (
    <div className={s.article}>
      ...
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Зачем Redis, если есть PostgreSQL</h2>
        <p className={s.lead}>
      ...
      {/* ── 2. String ───────────────────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>String — базовая структура</h2>
        <p className={s.body}>
        ...
        <pre className={s.codeBlock}><code>{`// Кеш с TTL
...
if (!lock) throw new Error('Another process is running');`}</code></pre>
      </section>

      {/* ── 3. Hash ─────────────────────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Hash — объекты и сессии</h2>
        <p className={s.body}>
        ...
        <pre className={s.codeBlock}><code>{`// Сессия пользователя
...
// Три операции, не атомарно, перезаписываешь всё`}</code></pre>
      </section>

      {/* ── 4. List ─────────────────────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>List — очереди и история</h2>
        <p className={s.body}>
        ...
        <pre className={s.codeBlock}><code>{`// Job queue: producer добавляет, consumer забирает
// Producer:
...
// он даёт retry, priority, concurrency поверх Redis`}</code></pre>
      </section>

      {/* ── 5. Set ──────────────────────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Set — уникальные элементы</h2>
        <p className={s.body}>
        ...
        <pre className={s.codeBlock}><code>{`// Уникальные посетители за день (HyperLogLog для масштаба)
...
const can = await redis.sIsMember(\`user:\${id}:permissions\`, 'write:comments');`}</code></pre>
      </section>

      {/* ── 6. Sorted Set ───────────────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Sorted Set — ранкинги и временные ряды</h2>
        <p className={s.body}>
        ...
        <pre className={s.codeBlock}><code>{`// Leaderboard
...
await redis.expire(key, 60);`}</code></pre>
      </section>

      {/* ── 7. Playground ───────────────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Redis в браузере</h2>
        <p className={s.body}>
      ...
      {/* ── 8. TTL и naming ─────────────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>TTL, naming и eviction</h2>
        <p className={s.body}><strong>Naming convention:</strong></p>
        <pre className={s.codeBlock}><code>{`// Используй : как разделитель, включай тип сущности и id
...
// Ключи чувствительны к регистру: User:42 ≠ user:42`}</code></pre>
      ...
      {/* ── 9. Pub/Sub ──────────────────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Pub/Sub — real-time события</h2>
        <p className={s.body}>
        ...
        <pre className={s.codeBlock}><code>{`// Publisher (один инстанс):
...
// XREAD BLOCK 0 STREAMS stream $`}</code></pre>
      ...
      {/* ── 10. Практика Node.js ────────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Практика: Node.js + ioredis / node-redis</h2>
        <pre className={s.codeBlock}><code>{`// npm install ioredis
...
// [[null, 'OK'], [null, 'OK'], [null, 1]]`}</code></pre>
      </section>
