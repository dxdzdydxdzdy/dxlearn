  ...
  return (
    <div className={s.article}>
      ...
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Проблема: Sequential Scan</h2>
        <p className={s.lead}>
      ...
      {/* 2. Demo */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Seq Scan vs Index Scan — наглядно</h2>
        <p className={s.body}>
      ...
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Как устроен B-tree индекс</h2>
        <p className={s.lead}>
...
-- Итого: ~3 чтения дерева + 4 чтения таблицы`} />
      ...
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Автоматические индексы</h2>
        <p className={s.lead}>
...
CREATE INDEX idx_users_dept ON users (dept_id);`} />
      ...
      <section className={s.section}>
        <h2 className={s.sectionTitle}>CREATE INDEX — синтаксис</h2>
        <p className={s.lead}>
...
WHERE tablename = 'users';`} />
      ...
      {/* 6. Типы индексов */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Типы индексов в PostgreSQL</h2>
        <p className={s.lead}>
...
CREATE INDEX idx_hash_email ON users USING HASH (email);`} />
      ...
      {/* 7. Составные индексы */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Составные индексы и leftmost prefix</h2>
        <p className={s.lead}>
...
-- idx_b не подойдёт (user_id вторым, без status)`} />
      ...
      {/* 8. EXPLAIN ANALYZE */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>EXPLAIN ANALYZE — читаем план запроса</h2>
        <p className={s.lead}>
...
ORDER BY idx_scan ASC;  -- ASC = редко используемые наверху`} />
      ...
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Когда индекс не нужен или вреден</h2>
        <p className={s.lead}>
      ...
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Partial и Covering индексы</h2>
        <p className={s.lead}>
...
-- → Index Scan (нужно читать строки из таблицы для product и amount)`} />
      ...
      {/* 11. Summary table */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Шпаргалка по типам сканирования</h2>
