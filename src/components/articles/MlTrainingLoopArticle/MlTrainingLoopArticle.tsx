  ...
  return (
    <div className={s.article}>
      ...
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Зачем фронтенд-разработчику знать про обучение</h2>
        <p className={s.lead}>
      ...
      {/* ── 2. Данные ─────────────────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Данные: откуда начинается всё</h2>
        <p className={s.body}>
        ...
        <div className={s.codeBlock}>
          <div className={s.codeBlockHeader}>PyTorch: загрузка данных</div>
          <code>{`import torch
...
val_loader   = DataLoader(val_ds,   batch_size=64, shuffle=False)`}</code>
        </div>
      </section>

      {/* ── 3. Forward pass ──────────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Forward pass: модель делает предсказание</h2>
        <p className={s.body}>
        ...
        <div className={s.codeBlock}>
          <div className={s.codeBlockHeader}>Определение модели и forward pass</div>
...
# logits.shape = (32, 2) — по два числа на каждый из 32 примеров`}</code>
        </div>
      </section>

      {/* ── 4. Loss + backward ───────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Loss и backward: считаем ошибку и обновляем веса</h2>
        <p className={s.body}>
        ...
        <div className={s.codeBlock}>
          <div className={s.codeBlockHeader}>Один шаг обучения: loss → backward → step</div>
...
print(f"loss: {loss.item():.4f}") # 0.6931 в начале → 0.15 после обучения`}</code>
        </div>
      </section>

      {/* ── 5. Full training loop ────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Полный training loop</h2>
        <p className={s.body}>
        ...
        <div className={s.codeBlock}>
          <div className={s.codeBlockHeader}>Полный training loop с валидацией</div>
          <code>{`def train_epoch(model, loader, criterion, optimizer, device, scheduler=None):
    model.train()
...
for epoch in range(1, NUM_EPOCHS + 1):
    ...
    if val_loss < best_val_loss:
      ...
      {/* ── 6. Simulator ─────────────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Симулятор: train loss vs val loss</h2>
        <p className={s.body}>
      ...
      {/* ── 7. Гиперпараметры ────────────────────────────────────────────── */}
      <section className={s.section}>
        <h2 className={s.sectionTitle}>Ключевые гиперпараметры</h2>
        <p className={s.body}>
      ...
      <section className={s.section}>
        <h2 className={s.sectionTitle}>GPU и экономия памяти</h2>
        <p className={s.body}>
